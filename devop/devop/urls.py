...
from devop.views.hosts import ListHost, AddHost, DeleHost, EditHost,UploadHost,WriteHost
...
urlpatterns = [
    ...
    url(r'^upload/host/$', UploadHost, name='uploadhost'),
    url(r'^host/data/(?P<ID>\d+)/$', WriteHost, name='writehost'),
